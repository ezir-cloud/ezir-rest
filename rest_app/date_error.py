...
class GitRepoApisDetails:
    ...
    def add_job_by_time(self, target_url, run_date, uid):
        ...
        github_api = job_details_by_githubapi(JobId=uid, JobType='github', CreatedAt=run_date, UpdatedAt='',
                                              JobObject=job_details_json, Jobstatus='pending', Joblog='job log',
                                              previousjobid='0')
...
obj.get_repo_details_by_month("dockerfile", 2020, 4, 2020, 8, 5, 16, 29, 10, 3)
