...
class GitRepoApisDetails:
    ...
    def job_is_get_repo(self, query_url, job_id):
        ...
        try:
            ...
            count_fails_job = int(select_rows.first()) + 1
            ...
            self.re_add_fail_jobs(job_id, query_url, count_fails_job)

    def re_add_fail_jobs(self, job_id, query_url, count_fails_job):

        if count_fails_job > 3:
...
obj.get_repo_details_by_month("dockerfile", 2020, 4, 2020, 8, 5, 19, 24, 00, 10)
